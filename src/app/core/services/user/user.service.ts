...
export class UserService {
  // private isAppTypeREST: boolean;
  // private customerRestResource = 'customers';
    ...
    return this.appFacade.customerRestResource$.pipe(
      concatMap(restResource =>
        customer.isBusinessCustomer
          ? this.apiService.put<void>('customers/-/users/-/credentials/password', { password, currentPassword })
          : this.apiService.put<void>(`${restResource}/-/credentials/password`, {
              password,
              currentPassword,
            })
      )
